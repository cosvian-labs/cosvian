...
// source: bitora/fees/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "bitora.fees.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "bitora.fees.v1.QueryParamsResponse")
	proto.RegisterType((*QueryOraclePriceRequest)(nil), "bitora.fees.v1.QueryOraclePriceRequest")
	proto.RegisterType((*QueryOraclePriceResponse)(nil), "bitora.fees.v1.QueryOraclePriceResponse")
}

func init() { proto.RegisterFile("bitora/fees/v1/query.proto", fileDescriptor_a1d53a1fcc4584e1) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bitora.fees.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) OraclePrice(ctx context.Context, in *QueryOraclePriceRequest, opts ...grpc.CallOption) (*QueryOraclePriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bitora.fees.v1.Query/OraclePrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bitora.fees.v1.Query/Params",
	}
...
func _Query_OraclePrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bitora.fees.v1.Query/OraclePrice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bitora.fees.v1.Query",
	...
	Metadata: "bitora/fees/v1/query.proto",
}
