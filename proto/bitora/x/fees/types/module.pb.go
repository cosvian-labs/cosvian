...
// source: bitora/fees/module/v1/module.proto
...
func init() {
	proto.RegisterType((*Module)(nil), "bitora.fees.module.v1.Module")
}

func init() {
	proto.RegisterFile("bitora/fees/module/v1/module.proto", fileDescriptor_d526f0b227979d50)
}
