...
// source: bitora/treasury/module/v1/module.proto
...
func init() {
	proto.RegisterType((*Module)(nil), "bitora.treasury.module.v1.Module")
}

func init() {
	proto.RegisterFile("bitora/treasury/module/v1/module.proto", fileDescriptor_938543a4ba3bb42f)
}
