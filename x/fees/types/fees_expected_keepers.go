...
type FeesKeeper interface {
	// ConvertUSDToCSV converts a USD-denominated LegacyDec into a CSV-denominated LegacyDec
	// and returns price data used for the conversion.
	ConvertUSDToCSV(ctx sdk.Context, usd math.LegacyDec) (math.LegacyDec, *PriceData, error)
