...
// source: bitora/bitora/module/v1/module.proto
...
func init() {
	proto.RegisterType((*Module)(nil), "bitora.bitora.module.v1.Module")
}

func init() {
	proto.RegisterFile("bitora/bitora/module/v1/module.proto", fileDescriptor_a957f2f984d8d494)
}
