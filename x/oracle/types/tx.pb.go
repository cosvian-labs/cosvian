...
// source: bitora/oracle/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "bitora.oracle.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "bitora.oracle.v1.MsgUpdateParamsResponse")
	proto.RegisterType((*MsgSetPrice)(nil), "bitora.oracle.v1.MsgSetPrice")
	proto.RegisterType((*MsgSetPriceResponse)(nil), "bitora.oracle.v1.MsgSetPriceResponse")
}

func init() { proto.RegisterFile("bitora/oracle/v1/tx.proto", fileDescriptor_b4e4d57ab035af90) }
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bitora.oracle.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetPrice(ctx context.Context, in *MsgSetPrice, opts ...grpc.CallOption) (*MsgSetPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bitora.oracle.v1.Msg/SetPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bitora.oracle.v1.Msg/UpdateParams",
	}
...
func _Msg_SetPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bitora.oracle.v1.Msg/SetPrice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bitora.oracle.v1.Msg",
	...
	Metadata: "bitora/oracle/v1/tx.proto",
}
