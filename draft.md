...
func (k Keeper) ChargeAndDistributeFeeByType(
    ...
    csvPrice := oracleKeeper.GetCSVPerUSD(ctx)
    feeCSV := feeConfig.AmountUSD.Quo(csvPrice).Mul(math.LegacyNewDec(1_000_000))
    feeCoin := sdk.NewCoin("ucsv", feeCSV.TruncateInt())
